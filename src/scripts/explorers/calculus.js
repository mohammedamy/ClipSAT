/* Canvas explorers for the calculus track (Plan 5 Phase 5.015, ADR 0039).
   Moved verbatim out of modules/02-core-app.js. build.js minifies this file to
   public/js/ex/calculus.js, which base.njk loads only on the calculus page, right after
