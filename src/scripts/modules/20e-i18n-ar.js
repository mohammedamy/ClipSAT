/* Arabic UI strings for window.i18n (20c-i18n.js). Shipped on its own as
   public/js/i18n-ar.js (deferred-manifest.json) and loaded only when a visitor
   switches to Arabic or has Arabic saved, not with every page (ADR 0040). */
(function(){
  if(!window.i18n||!window.i18n._addStrings) return;
  window.i18n._addStrings('ar', {
