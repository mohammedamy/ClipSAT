/* ── AI practice quiz (deferred) ─────────────────────────────────────────
   Split out of 03-ai-chat-and-practice-quiz.js (Plan 5 Phase 5.015, ADR 0036)
   and shipped as public/js/practice-quiz.js. Its only entry point is
   window.launchPracticeQuiz(mistake), reached from "Still unsure" in the
   mistakes review (13-mistakes-review.js); 03's loader stub fetches this
   file on first use and hands the call on through window.CSPracticeQuiz.
   Globals it relies on are all eager: _openrouterChat (03), escHtml (13),
   openAISettings / openCloudAuthModal / openChatWith / _shuffle / CSExport. */
(function(){
/* ═══════════════════════════════════════════════════════════════
...
function showPQResult(ov, score, total, origMistake, userAnswers, questions){
  ...
  window.CSPracticeQuiz={launch:window.launchPracticeQuiz};
})();
