/* Interactive Practice data for /calculus/ - one entry per chapter section id.
   Shipped as public/js/ix/calculus.js and loaded only on that track's page by the
