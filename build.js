  ...
  <footer class="site">
    <div class="wrap foot-grid">
      ...
      <div style="font-family:var(--sans); font-size:.86rem; color:var(--muted)">
        ...
        <button class="footer-legal-link" onclick="openLegal('privacy')">Privacy Policy</button> ·
        <button class="footer-legal-link" onclick="openLegal('terms')">Terms of Service</button>
      </div>
    </div>
  ...
  <div id="legal-overlay" class="legal-overlay" role="dialog" aria-modal="true" aria-label="Legal" onclick="if(event.target===this)closeLegal()">
    <div class="legal-box">
      ...
      <div id="legal-privacy" style="display:none">
        ...
        <p class="lu">Last updated July 8, 2026</p>
        <p>ClipSAT is a static study site with no user accounts and no server-side database of your personal information. This page explains what little data does exist and how it's handled.</p>
        <h3>What's stored on your device</h3>
        <ul>
          <li>Progress, streaks, mistake log, and dark-mode preference are saved in your browser's local storage. They never leave your device and are not visible to us.</li>
          <li>If you use "Ask Mr. Mohamed," your questions are sent directly to a third-party AI provider to generate a reply; they are not stored on any ClipSAT server.</li>
        </ul>
        <h3>Third-party links</h3>
        <p>Links to WhatsApp, Telegram, YouTube, Instagram, TikTok, Facebook, and PayPal take you to those companies' own sites, each governed by its own privacy policy.</p>
        <h3>Contact</h3>
        <p>Questions about this policy can be sent via <a href="https://wa.me/966597688647" target="_blank" rel="noopener">WhatsApp</a> or <a href="https://t.me/ClipSAT22" target="_blank" rel="noopener">Telegram</a>.</p>
      </div>
      <div id="legal-terms" style="display:none">
        <h2>Terms of Service</h2>
        <p class="lu">Last updated July 8, 2026</p>
        <p>By using ClipSAT you agree to the following.</p>
        <h3>Use of content</h3>
        <p>Notes, explorers, and practice questions are provided for personal study. Downloaded packets may be used for your own review; please don't redistribute or resell them.</p>
        <h3>No guarantee of results</h3>
        <p>ClipSAT is a study aid, not a guarantee of any particular exam score. Always check official curriculum documents (e.g. Cambridge, IB, College Board, Qiyas) for the authoritative syllabus.</p>
        <h3>AI tutor</h3>
        <p>"Ask Mr. Mohamed" is an AI assistant, not Mr. Mohamed Abdallah himself. Double-check important steps and final answers yourself.</p>
        <h3>Contact</h3>
        <p>Questions can be sent via <a href="https://wa.me/966597688647" target="_blank" rel="noopener">WhatsApp</a> or <a href="https://t.me/ClipSAT22" target="_blank" rel="noopener">Telegram</a>.</p>
      </div>
    </div>
  </div>
