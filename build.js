...
<body class="track-{{ trackId }}">
  ...
  <div id="cs-breadcrumb" class="{% if trackId == 'home' or trackId == 'privacy' or trackId == 'terms' or trackId == 'contact' or trackId == 'cookies' %}bc-hidden{% endif %}" aria-label="You are here">
  ...
  (function(){
    ...
    var URLS = {
      ...
      appc:'appc',apstats:'apstats',ibsl:'ibsl',ibhl:'ibhl',linalg:'linalg',home:''
    };
