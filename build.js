...
<body class="track-{{ trackId }}">
  ...
  <div id="cs-breadcrumb" class="{% if trackId == 'home' or trackId == 'privacy' or trackId == 'terms' or trackId == 'contact' or trackId == 'cookies' or trackId == 'calculator' %}bc-hidden{% endif %}" aria-label="You are here">
